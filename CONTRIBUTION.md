# Contribution Guidelines — Icons Pack
...
```text
ICONS PACK/
├── ICONS PACK.md          # Obsidian entry point
...
├── assets/
│   ├── icons_pack.webp    # Static preview image
│   └── iconspack.clip.gif # Immersive preview clip
└── src/
    ├── index.jsx          # CSS Injector & reload daemon
    ├── App.jsx            # Main layout and coordinator
    ├── components/
    │   ├── PreviewPanel.jsx # Left panel preview + snippets
    │   └── BrowserPanel.jsx # Right panel iframe browser
    └── utils/
